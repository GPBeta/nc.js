...
class VersionsObject : public JsObjecT<VersionsObject> {
    ...
    NCJS_BEGIN_OBJECT_FACTORY()
        NCJS_MAP_OBJECT_READONLY(String, NCJS_ALIAS_STRING, NCJS_VERSION_STRING)
        NCJS_MAP_OBJECT_READONLY(String, "cef",             NCJS_REFTEXT(CEF_VERSION))
        NCJS_MAP_OBJECT_READONLY(String, "libcef",          GetLibCefVersion())
        NCJS_MAP_OBJECT_READONLY(String, "chromium",        GetChromiumVersion())
        NCJS_MAP_OBJECT_READONLY(String, "node",            NODE_VERSION_STRING)
        NCJS_MAP_OBJECT_READONLY(String, "uv",              uv_version_string())
        NCJS_MAP_OBJECT_READONLY(String, "modules",         NCJS_MAKESTR(NODE_MODULE_VERSION))
        //NCJS_MAP_OBJECT_READONLY(String, "http_parser",    NCJS_REFTEXT(HTTP_PARSER_VERSION))
        //NCJS_MAP_OBJECT_READONLY(String, "v8",             GET_V8_VERSION)
        //NCJS_MAP_OBJECT_READONLY(String, "zlib",           NCJS_REFTEXT(ZLIB_VERSION))
        //NCJS_MAP_OBJECT_READONLY(String, "ares",           NCJS_REFTEXT(ARES_VERSION_STR))
#if defined(NODE_HAVE_I18N_SUPPORT) && defined(U_ICU_VERSION)
        NCJS_MAP_OBJECT_READONLY(String, "icu",             NCJS_REFTEXT(U_ICU_VERSION))
#endif // defined(NODE_HAVE_I18N_SUPPORT) && defined(U_ICU_VERSION)
#if HAVE_OPENSSL
        NCJS_MAP_OBJECT_READONLY(String, "openssl",         GET_OPENSSL_VERSION)
#endif // HAVE_OPENSSL
...
class ReleaseObject : public JsObjecT<ReleaseObject> {
    ...
    NCJS_BEGIN_OBJECT_FACTORY()
        NCJS_MAP_OBJECT_READONLY(String, "name", NCJS_REFTEXT(NCJS_NAME_STRING))
        //NCJS_MAP_OBJECT_READONLY(String, "sourceUrl", GET_SOURCE_URL)
        //NCJS_MAP_OBJECT_READONLY(String, "headersUrl", GET_HEADERS_URL)
        //NCJS_MAP_OBJECT_READONLY(String, "libUrl", GET_LIB_URL)
#if NCJS_VERSION_IS_LTS
        NCJS_MAP_OBJECT_READONLY(String, "lts", NCJS_REFTEXT(NCJS_VERSION_LTS_CODENAME))
...
class ProcessObject : public JsObjecT<ProcessObject> {
    ...
    NCJS_BEGIN_OBJECT_FACTORY()
        // constants
        NCJS_MAP_OBJECT_READONLY(String, "version",  NODE_VERSION)
        NCJS_MAP_OBJECT_READONLY(String, "arch",     NCJS_REFTEXT(NCJS_ARCH))
        ...
        // functions
        NCJS_MAP_OBJECT_FUNCTION("binding", Binding)
        NCJS_MAP_OBJECT_FUNCTION("_linkedBinding", LinkedBinding)
        NCJS_MAP_OBJECT_FUNCTION("_startProfilerIdleNotifier", StartProfilerIdleNotifier)
        NCJS_MAP_OBJECT_FUNCTION("_stopProfilerIdleNotifier", StopProfilerIdleNotifier)
        NCJS_MAP_OBJECT_FUNCTION("_getActiveRequests", GetActiveRequests)
        NCJS_MAP_OBJECT_FUNCTION("_getActiveHandles", GetActiveHandles)
        NCJS_MAP_OBJECT_FUNCTION("chdir", Chdir)
        NCJS_MAP_OBJECT_FUNCTION("cwd", Cwd)
        NCJS_MAP_OBJECT_FUNCTION("umask", Umask)
        NCJS_MAP_OBJECT_FUNCTION("_kill", Kill)
        NCJS_MAP_OBJECT_FUNCTION("hrtime", Hrtime)
        NCJS_MAP_OBJECT_FUNCTION("dlopen", DLOpen)
        NCJS_MAP_OBJECT_FUNCTION("uptime", Uptime)
        NCJS_MAP_OBJECT_FUNCTION("memoryUsage", MemoryUsage)
        NCJS_MAP_OBJECT_FUNCTION("_setupPromises", SetupPromises)
        NCJS_MAP_OBJECT_FUNCTION("_setupDomainUse", SetupDomainUse)
        // accessors
        NCJS_MAP_OBJECT_ACCESSOR("env", EnvAccessor)
    NCJS_END_OBJECT_FACTORY()
};
